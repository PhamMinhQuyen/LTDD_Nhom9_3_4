        ...
        btnAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (intentData.length() > 0) {
                    if (isEmail)
                        startActivity(new Intent(ScannedBarcodeActivity.this, EmailActivity.class).putExtra("Địa chỉ gmail", intentData));
                    else {
                    ...
                    txtBarcodeValue.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (barcodes.valueAt(0).email != null) {
                                ...
                                isEmail = true;
                                btnAction.setText("Thêm nội dung vào gmail");
                            } else {
                                isEmail = false;
                                btnAction.setText("Đến Website bằng url");
